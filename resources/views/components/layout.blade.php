...
<html lang="en">
    ...
    <body class="bg-vs-bg text-vs-text antialiased" style="font-family: 'JetBrains Mono', monospace;">
        ...
        {{-- VS Code top bar — screen only --}}
        <div class="no-print sticky top-0 z-10 flex items-center justify-between border-b border-vs-border px-4 py-2"
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 rounded-t border-t-2 bg-vs-bg px-4 py-1.5 text-xs text-vs-text"
            ...
            <a class="flex items-center gap-2 rounded border border-vs-border px-3 py-1.5 text-xs text-vs-comment transition hover:border-vs-blue hover:text-vs-text"
                ...
                </svg>Print / Export PDF</a>

        </div>

        {{-- Main editor layout --}}
        <div class="screen-wrapper mx-auto max-w-5xl px-0 sm:px-6 py-6 print-page">
            <div class="flex min-h-screen">
                {{-- Line numbers — screen only --}}
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (gutter && content && window.innerWidth > 640) {
                    const lines = Math.floor(content.offsetHeight / 21) - 3;
                    if (lines > 0) {
